...
const ContinuityBridgesPage = () => {
  const dispatch = useDispatch('continuity-bridges');
        ...
        <div className="max-w-3xl mx-auto prose prose-invert">
          ...
          <section className="space-y-8">
            ...
            {dispatch.content.bridges.map((bridge: any) => (
              <Card key={bridge.id} className="bg-black/40 border border-sigil-border">
                <CardHeader className="pb-2">
                  <div className="flex justify-between items-center">
                    <h3 className="text-xl font-mono text-sigil-accent">{bridge.id}</h3>
                    <div className="flex items-center gap-2 text-sm text-gray-300">
